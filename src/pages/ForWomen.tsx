...
export default function ForWomen() {
  useEffect(() => {
    document.title = 'For Women — Silk & Shine Club Hair Membership';
  }, []);
    ...
    <main>
      ...
      <section className="page-hero">
        ...
        <div className="container page-hero__content">
          ...
          <div className="section-label">Women's Programme</div>
          <h1 className="page-hero__title">Silk &amp; Shine Club<br />For Women</h1>
          <p className="page-hero__desc">
            At Silk &amp; Shine, we understand the unique challenges women face — stress, hormonal
            changes, and environmental damage. Our specialised treatments are designed to nourish,
            strengthen, and restore your hair. Tailored to your specific needs.
          </p>
        </div>
      </section>
          ...
          <div className="membership-detail__intro">
            <div>
              ...
              <p className="section-subtitle" style={{ marginBottom: '32px' }}>
                ...
                Whether you're dealing with thinning, dryness, or seeking a healthy shiny mane —
